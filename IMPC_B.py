...
def get_and_split_by_center(procedure_code, number_of_rows,fileName = ""):
	...
	if row_count > 1:
		...
		args = ["gawk", "-F,", "NR==1{header=$0}NR>1&&!a[$12]++{print header > (\"" + output_directory + "\"$12\".csv\")}NR>1{print > (\"" + output_directory + "\"$12\".csv\")}", fileName]
...
if __name__ == "__main__":
	create_wide_data("OFD", rewrite = False, number_of_rows = 10000000, pipeline = "IMPC")
