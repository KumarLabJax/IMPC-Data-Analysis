#This code generates the time of day longitudinal plots for IMPC data
...
#This generates four sets of time of day longitudinal plots organized by phenotyping center 
#two for the control set of mice with or without lines, and two for all of the mice with or without lines
produceAllTimeDaySeries(procedure_code, directory, isControl = T, isLine = T)
produceAllTimeDaySeries(procedure_code, directory, isControl = F, isline = T)
produceAllTimeDaySeries(procedure_code, directory, isControl = F, isline = F)
produceAllTimeDaySeries(procedure_code, directory, isControl = T, isline = F)
